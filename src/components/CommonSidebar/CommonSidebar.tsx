...
const sidebarItems: SidebarItem[] = [
  { href: "/epaper", src: "/images/sidebar-1.gif", alt: "Sidebar 1" },
  { href: "/epaper", src: "/images/sidebar-2.png", alt: "Sidebar 2" },
  { href: "/epaper", src: "/images/sidebar-3.png", alt: "Sidebar 3" },
  { href: "/epaper", src: "/images/sidebar-4.gif", alt: "Sidebar 4" },
  { href: "/epaper", src: "/images/sidebar-5.gif", alt: "Sidebar 5" },
    ...
    <div className="mb-4 md:mb-0">
      ...
      <div className="mt-5">
        <div className="card">
          ...
          >
            <div className="py-2 mb-0 text-center text-white">গুরুত্বপূর্ণ</div>
          </div>

          <div className="card-body p-3 sidebar_bigapon_area border border-gray-200 rounded-none">
            <div className="p-3 px-3">
              <div className="mx-4 mb-2">
                <a href="/ad-rate-print">
      ...
      <div className="mt-5">
        ...
        <div className="mt-5 space-y-3">
          {visibleItems.map((item, index) => (
            <div
              key={index}
              className="card border border-gray-200 rounded-none"
            >
              <Link href={item.href}>
                <Image
                  src={item.src}
